...
local function clearFade(entity)
    ...
    -- _P("[BG3SX][Effect.lua] - Effect:Fade - clearFade - ScreenFade cleared for ", entity)
end
...
function Effect:Fade(entity, duration)
    if Entity:IsPlayable(entity) then
        ...
        -- _P("[BG3SX][Effect.lua] - Effect:Fade - ScreenFade started for ", entity)
...
function Effect:Trigger(entity, effect)
    ...
    -- _P("[BG3SX][Effect.lua] - Effect:Trigger - Effect ", effect, " added to ", entity)
end